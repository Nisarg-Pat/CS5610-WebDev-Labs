    ...
    return (
        <div className="row pt-2">
            ...
            <div className="wd-relative">
                <img src={profileState.backImage} className="wd-profile-imgBack" alt="Profile Back"/>
                <div className="wd-profile-inner-img">
                    <img src={profileState.frontImage} className="wd-profile-imgFront" alt="Profile Front"/>
                </div>
            </div>
            <div className="col-9"/>
            <div className="pt-4"/>
